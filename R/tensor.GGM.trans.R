...
#'
#' @author Mingyang Ren <renmingyang17@mails.ucas.ac.cn>, Yaoming Zhen, and Junhui Wang
...
#' \describe{
#' \item{Omega.list}{The final estimation result of the target precision matrices after the model selection of transfer learning-based estimation and initial estimation (in which the initial covariance matrices of auxiliary domains is weighted by sample sizes).}
#' \item{Omega.sym.list}{The symmetrized final estimation result in Omega.list.}
#' \item{Omega.list.diff}{The final estimation result of the target precision matrices after the model selection of transfer learning-based estimation and initial estimation (in which the initial covariance matrices of auxiliary domains is weighted by the differences with the target domain).}
#' \item{Omega.sym.list.diff}{The symmetrized final estimation result in Omega.list.diff.}
#' \item{res.trans.list}{Transfer learning-based estimation results.}
#' }
#' @export
#'
